...
import { rsvpSchema, type RsvpFormInput, type RsvpFormValues } from '@/schemas/rsvp';
      ...
      <Field label='男方或女方親友' error={errors.side?.message}>
        <div className='mt-1 grid grid-cols-2 gap-3'>
          ...
          <label className={radioClassName}>
            ...
            <span className='whitespace-normal break-words font-medium leading-5'>女方親友</span>
          </label>
        </div>
      </Field>
